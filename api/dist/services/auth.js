...
const registerUser = ({ email, password, profilePhoto, description, name }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const checkIs = yield personal_1.default.findOne({ email });
        if (checkIs)
            return "ALREADY_USER";
        const passhash = yield (0, bcrypt_handle_1.encrypt)(password);
        const registerNewUser = yield personal_1.default.create({ email, password: passhash, name, profilePhoto, description });
        if (!registerNewUser)
