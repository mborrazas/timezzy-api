...
const updateClientCtrl = ({ body, user, params }, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { comercio } = user;
    const { id } = params;
    const updateClientResponse = yield (0, client_1.updateClient)(body, comercio, id);
...
const deleteClientCtrl = ({ params, user }, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { comercio } = user;
    const { id } = params;
...
const getClientCtrl = ({ body, user, params }, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { comercio } = user;
    const { id } = params;
